...
{
    public partial class frmVedereBar : Form
    {
        public frmVedereBar()
        {
            InitializeComponent();
        ...
        private void frmVedereBar_Load(object sender, EventArgs e)
        {
            PrimireComenzi();
        }
    ...
    WHERE d.MainID = c.MainID
      ...
      AND d.isNewItem = 1
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                string qry2 = @"SELECT p.produseNume, d.cantitate, d.isNewItem
                            FROM detaliicomanda d
        ...
        private void b_click(object sender, EventArgs e)
        {
            ...
            // Mesaj de confirmare folosind MessageBox simplu
            ...
            {
                string qry = @"Update comanda set StatusBar ='Finalizat' where MainID=@ID";
                string qryDetalii = @"
