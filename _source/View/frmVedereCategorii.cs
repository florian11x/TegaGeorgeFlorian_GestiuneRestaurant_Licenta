...
{
    public partial class frmVedereCategorii : frmVedereModel
    {
        public frmVedereCategorii()
        {
            InitializeComponent();
        ...
        public void GetData()
        {
            string qry = "Select * FROM categorii where categoriiNume like '%"+guna2TextBox1.Text+"%' ";
            ...
            if (guna2DataGridView1.Columns.Contains("OrdineAfisare"))
            {
                guna2DataGridView1.Columns["OrdineAfisare"].Visible = false;
            }

        }

        private void frmVedereCategorii_Load(object sender, EventArgs e)
        {
            GetData();
        }
        ...
        {
            MainClass.BlurBackground(new frmAdaugareCategorii());
        ...
        private void guna2DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (guna2DataGridView1.CurrentCell.OwningColumn.Name == "dgvDel")
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string qry = "Delete from categorii where categoriiID=" + id + " ";
                    Hashtable ht = new Hashtable();
                    MainClass.SQl(qry, ht);

  
                    MessageBox.Show("Categorie ștearsă cu succes!",
                                    "Informație",
